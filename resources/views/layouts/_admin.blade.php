...
<head>
    ...
    <!-- ace styles -->
    <link rel="stylesheet" href="{{asset('lib/ace/css/ace.min.css')}}" class="ace-main-stylesheet" id="main-ace-style" />

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="{{asset('lib/ace/css/ace-part2.min.css')}}" class="ace-main-stylesheet" />
    <![endif]-->
